...
import 'package:niiflicks/utils/global_utility.dart';
import 'package:niiflicks/utils/widgethelper/widget_helper.dart';

class ColorConst {
  // "63FF90"
  static Color APP_COLOR = Colors.red;
  ...
  static Color BLACK_COLOR = isDarkMode() ? Colors.black : Colors.black;
  static Color WHITE_COLOR = isDarkMode() ? Colors.black : Colors.black;
  static Color BLACK_BG_COLOR = Colors.black54;
  static Color WHITE_BG_COLOR = isDarkMode() ? Colors.black : Colors.black;
