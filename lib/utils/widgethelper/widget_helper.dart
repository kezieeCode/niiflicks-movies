...
import 'package:niiflicks/utils/SlideRoute.dart';
import 'package:niiflicks/utils/apiutils/api_response.dart';
...
AppBar getAppBarWithBackBtn(
    ...
    List<Widget> actions}) {
  return AppBar(
    backgroundColor: bgColor == null ? Colors.blue : bgColor,
    leading: icon,
    actions: actions,
    elevation: elevation,
    centerTitle: true,
