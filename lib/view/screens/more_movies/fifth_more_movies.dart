...
import 'package:niiflicks/view/screens/more_movies/sixth_more_movies.dart';
...
class FifthMoreMovies extends StatefulWidget {
  @override
  _FifthMoreMoviesState createState() => _FifthMoreMoviesState();
// }
...
// class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: FifthMoreMovies(),
    );
  }
}

class _FifthMoreMoviesState extends State<FifthMoreMovies> {
            ...
            IconButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => SixthMoreMovies()));
                },
                icon: Icon(
