...
import 'package:niiflicks/view/screens/more_movies/ninth_more_movies.dart';
...
class EighthMoreMovies extends StatefulWidget {
  @override
  _EighthMoreMoviesState createState() => _EighthMoreMoviesState();
// }
...
// class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: EighthMoreMovies(),
    );
  }
}

class _EighthMoreMoviesState extends State<EighthMoreMovies> {
            ...
            IconButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => NinthMoreMovies()));
                },
                icon: Icon(
