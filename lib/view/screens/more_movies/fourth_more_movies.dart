...
import 'package:niiflicks/view/screens/more_movies/fifth_more_movies.dart';
...
class FourthMoreMovies extends StatefulWidget {
  @override
  _FourthMoreMoviesState createState() => _FourthMoreMoviesState();
// }
...
// class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: FourthMoreMovies(),
    );
  }
}

class _FourthMoreMoviesState extends State<FourthMoreMovies> {
            ...
            IconButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => FifthMoreMovies()));
                },
                icon: Icon(
