...
class TenthMoreMovies extends StatefulWidget {
  @override
  _TenthMoreMoviesState createState() => _TenthMoreMoviesState();
// }
...
// class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: TenthMoreMovies(),
    );
  }
}

class _TenthMoreMoviesState extends State<TenthMoreMovies> {
