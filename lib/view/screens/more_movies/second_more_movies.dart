...
import 'package:niiflicks/view/screens/more_movies/third_more_movies.dart';
...
class SecondMoreMovies extends StatefulWidget {
  @override
  _SecondMoreMoviesState createState() => _SecondMoreMoviesState();
// }
...
// class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: SecondMoreMovies(),
    );
  }
}

class _SecondMoreMoviesState extends State<SecondMoreMovies> {
            ...
            IconButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ThirdMoreMovies()));
                },
                icon: Icon(
