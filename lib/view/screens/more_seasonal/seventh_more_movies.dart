...
import 'package:niiflicks/view/screens/more_movies/eighth_more_movies.dart';
...
class SeventhMoreMovies extends StatefulWidget {
  @override
  _SeventhMoreMoviesState createState() => _SeventhMoreMoviesState();
// }
...
// class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: SeventhMoreMovies(),
    );
  }
}

class _SeventhMoreMoviesState extends State<SeventhMoreMovies> {
            ...
            IconButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => EighthMoreMovies()));
                },
                icon: Icon(
