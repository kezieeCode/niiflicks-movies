...
import 'package:niiflicks/view/screens/more_movies/tenth_more_movies.dart';
...
class NinthMoreMovies extends StatefulWidget {
  @override
  _NinthMoreMoviesState createState() => _NinthMoreMoviesState();
// }
...
// class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: NinthMoreMovies(),
    );
  }
}

class _NinthMoreMoviesState extends State<NinthMoreMovies> {
  ...
  Future movieLists() async {
    var url = 'https://universal-studios1.p.rapidapi.com/series.php';
    var uri = Uri.parse(url);
    final String second_page = '10';
      ...
      home: Scaffold(
            ...
            IconButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => TenthMoreMovies()));
                },
                icon: Icon(
        ...
        floatingActionButton: IconButton(
            onPressed: () => Navigator.push(
                context, MaterialPageRoute(builder: ((context) => MyMovies()))),
