...
import 'package:niiflicks/view/screens/more_movies/fourth_more_movies.dart';
...
class ThirdMoreMovies extends StatefulWidget {
  @override
  _ThirdMoreMoviesState createState() => _ThirdMoreMoviesState();
// }
...
// class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: ThirdMoreMovies(),
    );
  }
}

class _ThirdMoreMoviesState extends State<ThirdMoreMovies> {
            ...
            IconButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => FourthMoreMovies()));
                },
                icon: Icon(
