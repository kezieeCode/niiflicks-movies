...
import 'package:niiflicks/view/screens/more_movies/second_more_movies.dart';
...
class FirstMoreMovies extends StatefulWidget {
  @override
  _FirstMoreMoviesState createState() => _FirstMoreMoviesState();
// }
...
// class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: FirstMoreMovies(),
    );
  }
}

class _FirstMoreMoviesState extends State<FirstMoreMovies> {
            ...
            IconButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => SecondMoreMovies()));
                },
                icon: Icon(
