...
class liveChannelsPage extends StatefulWidget {
  @override
  _liveChannelsPageState createState() => _liveChannelsPageState();
// }
      ...
      home: Scaffold(
        ...
        body: FutureBuilder(
            ...
            builder: (BuildContext context,
                AsyncSnapshot<List<LiveChannel>> snapshot) {
              if (!snapshot.hasData) {
                return Center(
...
List<Widget> buildTrendingColumns(List<LiveChannel> data) {
  if (data.isNotEmpty) {
