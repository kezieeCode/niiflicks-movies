...
//Check if user has payed
  Future<Response> checkPayment() async {
...
//Mke payment now
  payNow() async {
    print(_email);
    // var payamount = _amount.text.trim() + "00";

    await pay(_email, _amount).then((value) async {
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => VideoPlayerScreenApi(
