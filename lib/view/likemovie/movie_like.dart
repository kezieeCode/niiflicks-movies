...
import 'package:niiflicks/view/likemovie/adapt.dart';
import 'package:niiflicks/view/likemovie/item_like.dart';
import 'package:niiflicks/view/likemovie/keepalive_widget.dart';
  ...
  final pages = [
    ...
    _SubscribeTopicPage(
        ...
        nextTapped: () {
          ...
          navigationPushReplacement(ctx, Login());
        }),
  ];
}
            ...
            child: SingleChildScrollView(
              ...
              child: Container(
                child: Column(children: [
                  ...
                  getTxtBlackColor(
                      msg: 'Now dive into the movie world',
                      fontSize: 30,
                  ...
                  Container(
                    ...
                    child: getTxtBlackColor(
                        msg:
                            'Now you can begin to enjoy unlimited movies in different categories ,all in the comfort of your couch.',
                        fontSize: 16,
                        textAlign: TextAlign.center,
                        fontWeight: FontWeight.w600),
                  ),
                  ...
                  child: SingleChildScrollView(
                      ...
                      child: Wrap(
                        ...
                        children: _genres.map<Widget>((d) {
                          ...
                          ..add(Container(
                              height: Adapt.px(900), width: Adapt.px(40)))
                          ..insert(
                              0,
                              Container(
                                  height: Adapt.px(900), width: Adapt.px(40))),
